...
export const Users = () => {
 ...
 const {candidatos, showData , nombre, email, tel ,cv, foto, postulaciones, localidad, filter} = useUsers();
                      ...
                      <tbody > 
                          {  
                              postulaciones.map((post)=>(
                                  <tr key={post._id} 
                                      className='animate__animated animate__fadeIn' 
                                      onClick={e=>navigate(`/admin/jobs?id=${post._id}`)} 
                                  >
                                      <td>   
                                      {post.titulo}
                                      </td>
